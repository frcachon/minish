...
minish: minish.o builtin.o linea2argv.o ejecutar.o externo.o builtin_cd.o builtin_dir.o builtin_help.o builtin_exit.o builtin_status.o builtin_setenv.o builtin_unsetenv.o builtin_getenv.o
